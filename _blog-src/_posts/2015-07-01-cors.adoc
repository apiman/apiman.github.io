...
Apiman plugins are referenced via their Maven coordinates, and can be installed most easily http://www.apiman.io/blog/plugins/policies/development/maven/2015/03/06/custom-policies.html#installing-a-plugin-into-apiman[via the apiman Admin UI] (or http://www.apiman.io/blog/rest/api/automation/2015/05/19/rest-api.html[REST interfaces] if you're looking to automate things).
