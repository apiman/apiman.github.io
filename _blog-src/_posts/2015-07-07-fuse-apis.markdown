...
To install the latest version of apiman follow this [guide](httpsio/latest/download.html). The installation process is again very simple, all you need to do is to extract the apiman overlay zip on top of [Wildly 8](https://www.wildfly.org/) server.
