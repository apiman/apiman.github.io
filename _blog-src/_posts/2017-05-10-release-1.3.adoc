...
* http://red.ht/2q31DBP[Release notes for 1.3.0.Final]

And of course, all of the standard sources of information have been updated:

* http://www.apiman.io/[The apiman project site]
...
For those that aren't familiar with Vert.x, it's an asynchronous, reactive toolkit that provides a high throughput and low latency platform is perfectly matched to the apiman gateway.
...
* Then try out the Headless ES  https://apiman.gitbooks.io/apiman-installation-guide/installation-guide/vertx/download.html#_elasticsearch[configuration] that ships with http://www.apiman.io/latest/download.html#vertx[the distro].
