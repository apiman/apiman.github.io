...
One common request we here is how to create custom URL patterns for the Apiman Gateway.
...
TIP: Check http://www.apiman.io/latest/developer-guide.html#_creating_a_plugin[out our documentation for creating Apiman Plugins] for more in-depth information.
...
```
$ git clone http://github.com/apiman/apiman-plugins.git
