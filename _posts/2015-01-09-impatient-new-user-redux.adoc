...
image::/assets/images/blog/2015-01-09/apiman_1.png[Dashboard]
...
image::/assets/images/blog/2015-01-09/apiman_2.jpg[Diagram_1]
...
image::/assets/images/blog/2015-01-09/apiman_3-redux.png[Diagram_2]
...
image::/assets/images/blog/2015-01-09/apiman_4-redux.png[Diagram_3]
...
image::/assets/images/blog/2015-01-09/Screenshot-4.png[Screenshot 4]
...
image::/assets/images/blog/2015-01-09/Screenshot-5.png[Screenshot 5]

Select the "New user" Option and register the API provider user:

image::/assets/images/blog/2015-01-09/Screenshot-6.png[Screenshot 6]

Then, logout and repeat the process to register a new client app developer user too:

image::/assets/images/blog/2015-01-09/Screenshot-7.png[Screenshot 7]
...
image::/assets/images/blog/2015-01-09/apiman_2.png[dash-2]

Select a name and description for the organization, and press "Create Organization":

image::/assets/images/blog/2015-01-09/Screenshot-15.png[Screenshot 15]

And, here's our organization:

image::/assets/images/blog/2015-01-09/Screenshot-16.png[Screenshot 16]
...
image::/assets/images/blog/2015-01-09/Screenshot-17.png[Screenshot 17]

Once the plan is created, we will add policies to it:

image::/assets/images/blog/2015-01-09/Screenshot-18.png[Screenshot 18]
...
image::/assets/images/blog/2015-01-09/Screenshot-19.png[Screenshot 19]

After we create the policy and add it to the plan, we have to lock the plan:

image::/assets/images/blog/2015-01-09/Screenshot-21.png[Screenshot 21]

And, here is the finished, and locked plan:

image::/assets/images/blog/2015-01-09/Screenshot-22.png[Screenshot 22]
...
image::/assets/images/blog/2015-01-09/Screenshot-23.png[Screenshot 23]
...
image::/assets/images/blog/2015-01-09/Screenshot-24.png[Screenshot 24]
...
image::/assets/images/blog/2015-01-09/Screenshot-25.png[Screenshot 25]

The plans tab shows which plans are available to be applied to the API:

image::/assets/images/blog/2015-01-09/Screenshot-26.png[Screenshot 26]
...
image::/assets/images/blog/2015-01-09/Screenshot-27.png[Screenshot 27]

After the authentication policy is added, we can publish the API to the API Gateway:

image::/assets/images/blog/2015-01-09/Screenshot-28.png[Screenshot 28]

And, here it is, the published API:

image::/assets/images/blog/2015-01-09/Screenshot-29.png[Screenshot 29]
...
image::/assets/images/blog/2015-01-09/Screenshot-30.png[Screenshot 30]
...
image::/assets/images/blog/2015-01-09/Screenshot-37.png[Screenshot 37]
...
image::/assets/images/blog/2015-01-09/Screenshot-38.png[Screenshot 38]
...
image::/assets/images/blog/2015-01-09/Screenshot-41.png[Screenshot 41]
...
image::/assets/images/blog/2015-01-09/Screenshot-40.png[Screenshot 40]
...
image::/assets/images/blog/2015-01-09/Screenshot-39.png[Screenshot 39]
