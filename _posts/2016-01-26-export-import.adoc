...
image::/assets/images/blog/2016-01-26/export_import_1.png[Image: Admin Choices]

Once you select the *Export/Import* Data feature, this menu is displayed:

image::/assets/images/blog/2016-01-26/export_import_2.png[Image: Export/Import Menu]
...
image::/assets/images/blog/2016-01-26/export_import_3.png[Image: Admin Choices]

The Management UI displays the status of the import as the data is processed:

image::/assets/images/blog/2016-01-26/export_import_4.png[Image: Admin Choices]
