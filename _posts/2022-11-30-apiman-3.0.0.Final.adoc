...
There is also a new Docker Compose distribution that makes Apiman easier than ever to try out; link:/download.html[please give it a go^] and {discussion}[let us know your thoughts^].
